...
export const Route = createFileRoute("/")(({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Convert multi-currency expenses to USD. Category totals, spend trends, top merchants, and a What-if EUR slider." },
    ],
  }),
  component: SpendlensApp,
} as any));
